...
from bionicscam.postprocessor import FRCPostProcessor
import argparse
import io
import sys
import tempfile
...
if __name__ == "__main__":
    ...
    INPUT_DXF = "./sample_junk_drawer/test_part.dxf"
    FUSION_REFERENCE = "./sample_junk_drawer/fusion_output.gcode"
