...
class GoogleDriveUploader:
    ...
    def _load_config(self):
        ...
        config_file = CONFIG_DIR / 'drive_config.json'
    ...
    def _save_config(self):
        ...
        with open(CONFIG_DIR / 'drive_config.json', 'w') as f:
        ...
        if not folder_id:
            return {
                ...
                'message': f"Folder '{folder_path}' not found in '{drive_name}'. "
                          f"Please create it manually or update config_cave/drive_config.json"
            }
