...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Global state (using appState object for cross-scope access)
        ...
        function buildCompositePreview(parts) {
            ...
            const gap = Math.max(Number(document.getElementById('toolDiameter')?.value) || 0.125, 0);
        ...
        function visualizeGcode(gcode) {
            ...
            // Keep G-code preview clean: do not draw the DXF setup overlay here.
            // The setup tab shows colored DXF placement; this tab should show only
            // the actual generated yellow toolpath so mismatches are not hidden.
        ...
        window.addEventListener('load', () => {
            ...
            if (dxfFiles && dxfFiles.length > 0 && fromOnshape) {
                ...
                // Parse all imported files for setup preview. This keeps the DXF
                // setup view aligned with the actual multi-part G-code job.
